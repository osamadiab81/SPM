    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-6 col-sm-12">
        <ul class="breadcrumb float-md-left">
          ...
          <li class="breadcrumb-item active"> التحكم في المدراء</li>
        </ul>
      </div>
    </div>
  </div>
            ...
            <div class="row clearfix">
              ...
              <div class="col-md-5">
                <div class="btn-group hidden-sm-down">
                  <button type="button" class="btn btn-simple btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="m-r-10 m-l-10 text-green">اضافة مدير نظام جديد</span>
                <button type="button" class="btn btn-success btn-icon btn-icon-mini hidden-sm-down slideDown" data-toggle="modal" data-target="#managerModal">
            ...
            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-info btn-icon btn-simple btn-icon-mini m-l-5" data-toggle="modal" data-target="#managerModal">
                ...
                <tr>
                  ...
                  <td>25/3/2020</td>
                  <td>
                    <button class="btn btn-danger btn-sm" data-type="cancel">
                      حظر
                    </button>
                  </td>
      ...
      <div class="modal-body">
        ...
        <form class="form_validation" method="POST">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger waves-effect" data-dismiss="modal"> إلغاء</button>
          </div>
        </form>
      </div>
    </div>
